...
public final class q0 {
    ...
    private static final String f15004d = q0.class.getSimpleName();

    /* renamed from: a  reason: collision with root package name */
    private final String f15005a;

    /* renamed from: b  reason: collision with root package name */
    private final SharedPreferences f15006b;
    ...
    */
    public q0(android.content.Context r3, java.lang.String r4) {
        /*
            r2 = this;
        ...
        L22:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p0.q0.<init>(android.content.Context, java.lang.String):void");
    }

    public /* synthetic */ q0(Context context, String str, int i10, kotlin.jvm.internal.g gVar) {
    ...
    private final void b(String str, Bundle bundle) {
        String str2;
        String string;
        String string2 = this.f15006b.getString(str, "{}");
        if (string2 == null) {
    ...
    public final void a() {
        this.f15006b.edit().clear().apply();
    }

    public final Bundle c() {
        Bundle bundle = new Bundle();
        for (String key : this.f15006b.getAll().keySet()) {
            try {
                ...
                aVar.a(r0Var, 5, TAG, "Error reading cached value for key: '" + ((Object) key) + "' -- " + e10);
                return null;
            }
        }
        return bundle;
