...
public final class c0 extends com.google.crypto.tink.shaded.protobuf.z<c0, b> implements t0 {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f18258a[z.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18258a[z.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f18258a[z.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f18258a[z.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f18258a[z.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f18258a[z.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends z.a<c0, b> implements t0 {
        ...
        public b B(c cVar) {
            v();
            ((c0) this.f6436k).Q(cVar);
            return this;
        }

        public c C(int i10) {
            return ((c0) this.f6436k).S(i10);
        }

        public int D() {
            return ((c0) this.f6436k).T();
        }

        public List<c> E() {
            return Collections.unmodifiableList(((c0) this.f6436k).U());
        }

        public b F(int i10) {
            v();
            ((c0) this.f6436k).Y(i10);
            return this;
        }
    }
    ...
    public static final class c extends com.google.crypto.tink.shaded.protobuf.z<c, a> implements t0 {
        ...
        public static final class a extends z.a<c, a> implements t0 {
            ...
            public a D(i0 i0Var) {
                v();
                ((c) this.f6436k).a0(i0Var);
                return this;
            }

            public a E(z zVar) {
                v();
                ((c) this.f6436k).b0(zVar);
                return this;
            }
        }
    ...
    private void R() {
        b0.i<c> iVar = this.key_;
        if (iVar.h()) {
            return;
        }
        this.key_ = com.google.crypto.tink.shaded.protobuf.z.D(iVar);
    }
