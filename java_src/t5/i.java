...
public final class i extends com.google.crypto.tink.shaded.protobuf.z<i, b> implements t0 {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f18269a[z.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18269a[z.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f18269a[z.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f18269a[z.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f18269a[z.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f18269a[z.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends z.a<i, b> implements t0 {
        ...
        public b B(com.google.crypto.tink.shaded.protobuf.i iVar) {
            v();
            ((i) this.f6436k).W(iVar);
            return this;
        }

        public b C(k kVar) {
            v();
            ((i) this.f6436k).X(kVar);
            return this;
        }
