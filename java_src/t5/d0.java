...
public final class d0 extends com.google.crypto.tink.shaded.protobuf.z<d0, b> implements t0 {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f18260a[z.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18260a[z.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f18260a[z.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f18260a[z.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f18260a[z.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f18260a[z.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends z.a<d0, b> implements t0 {
        ...
        public b B(c cVar) {
            v();
            ((d0) this.f6436k).Q(cVar);
            return this;
        }

        public b C(int i10) {
            v();
            ((d0) this.f6436k).U(i10);
            return this;
        }
    }
    ...
    public static final class c extends com.google.crypto.tink.shaded.protobuf.z<c, a> implements t0 {
        ...
        public static final class a extends z.a<c, a> implements t0 {
            ...
            public a C(i0 i0Var) {
                v();
                ((c) this.f6436k).V(i0Var);
                return this;
            }

            public a D(z zVar) {
                v();
                ((c) this.f6436k).W(zVar);
                return this;
            }
    ...
    private void R() {
        ...
        this.keyInfo_ = com.google.crypto.tink.shaded.protobuf.z.D(iVar);
    }
