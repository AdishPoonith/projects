...
public abstract class l extends h {
    ...
    private static final Logger f6255c = Logger.getLogger(l.class.getName());

    /* renamed from: d  reason: collision with root package name */
    private static final boolean f6256d = s1.E();
    ...
    public static class b extends l {
        ...
        final void A0(int i10, s0 s0Var, h1 h1Var) {
            M0(i10, 2);
            O0(((com.google.crypto.tink.shaded.protobuf.a) s0Var).m(h1Var));
            h1Var.i(s0Var, this.f6257a);
        }
        ...
        public final void O0(int i10) {
            if (!l.f6256d || d.c() || f0() < 5) {
                while ((i10 & (-128)) != 0) {
                    try {
                        byte[] bArr = this.f6259e;
                        int i11 = this.f6262h;
                        this.f6262h = i11 + 1;
                        bArr[i11] = (byte) ((i10 & 127) | 128);
                        i10 >>>= 7;
                    } catch (IndexOutOfBoundsException e10) {
                        throw new c(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f6262h), Integer.valueOf(this.f6261g), 1), e10);
                    }
                }
                byte[] bArr2 = this.f6259e;
                int i12 = this.f6262h;
                this.f6262h = i12 + 1;
                bArr2[i12] = (byte) i10;
            } else if ((i10 & (-128)) == 0) {
                byte[] bArr3 = this.f6259e;
                int i13 = this.f6262h;
                this.f6262h = i13 + 1;
                s1.K(bArr3, i13, (byte) i10);
            } else {
                byte[] bArr4 = this.f6259e;
                int i14 = this.f6262h;
                this.f6262h = i14 + 1;
                s1.K(bArr4, i14, (byte) (i10 | 128));
                int i15 = i10 >>> 7;
                if ((i15 & (-128)) == 0) {
                    byte[] bArr5 = this.f6259e;
                    int i16 = this.f6262h;
                    this.f6262h = i16 + 1;
                    s1.K(bArr5, i16, (byte) i15);
                    return;
                }
                byte[] bArr6 = this.f6259e;
                int i17 = this.f6262h;
                this.f6262h = i17 + 1;
                s1.K(bArr6, i17, (byte) (i15 | 128));
                int i18 = i15 >>> 7;
                if ((i18 & (-128)) == 0) {
                    byte[] bArr7 = this.f6259e;
                    int i19 = this.f6262h;
                    this.f6262h = i19 + 1;
                    s1.K(bArr7, i19, (byte) i18);
                    return;
                }
                byte[] bArr8 = this.f6259e;
                int i20 = this.f6262h;
                this.f6262h = i20 + 1;
                s1.K(bArr8, i20, (byte) (i18 | 128));
                int i21 = i18 >>> 7;
                if ((i21 & (-128)) == 0) {
                    byte[] bArr9 = this.f6259e;
                    int i22 = this.f6262h;
                    this.f6262h = i22 + 1;
                    s1.K(bArr9, i22, (byte) i21);
                    return;
                }
                byte[] bArr10 = this.f6259e;
                int i23 = this.f6262h;
                this.f6262h = i23 + 1;
                s1.K(bArr10, i23, (byte) (i21 | 128));
                byte[] bArr11 = this.f6259e;
                int i24 = this.f6262h;
                this.f6262h = i24 + 1;
        ...
        public final void R0(byte[] bArr, int i10, int i11) {
            try {
                System.arraycopy(bArr, i10, this.f6259e, this.f6262h, i11);
                this.f6262h += i11;
            } catch (IndexOutOfBoundsException e10) {
                throw new c(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f6262h), Integer.valueOf(this.f6261g), Integer.valueOf(i11)), e10);
            }
        }
        ...
        public final void V0(String str) {
            ...
            try {
                ...
                if (W2 == W) {
                    int i11 = i10 + W2;
                    this.f6262h = i11;
                    f10 = t1.f(str, this.f6259e, i11, f0());
                    this.f6262h = i10;
                    O0((f10 - i10) - W2);
                } else {
                    O0(t1.g(str));
                    f10 = t1.f(str, this.f6259e, this.f6262h, f0());
                }
                this.f6262h = f10;
            } catch (t1.d e10) {
                this.f6262h = i10;
        ...
        @Override // com.google.crypto.tink.shaded.protobuf.l
        public final int f0() {
            return this.f6261g - this.f6262h;
        }
    ...
    public static int H(s0 s0Var, h1 h1Var) {
        return C(((com.google.crypto.tink.shaded.protobuf.a) s0Var).m(h1Var));
    }
    ...
    public static int T(String str) {
        ...
        try {
            ...
            length = str.getBytes(b0.f6126b).length;
        }
        return C(length);
    }
    ...
    static int u(s0 s0Var, h1 h1Var) {
        return ((com.google.crypto.tink.shaded.protobuf.a) s0Var).m(h1Var);
    }
    ...
    final void b0(String str, t1.d dVar) {
        f6255c.log(Level.WARNING, "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) dVar);
        byte[] bytes = str.getBytes(b0.f6126b);
        try {
            O0(bytes.length);
