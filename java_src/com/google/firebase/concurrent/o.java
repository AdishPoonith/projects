...
public class o implements ScheduledExecutorService {
    ...
    private final ExecutorService f6692j;

    /* renamed from: k  reason: collision with root package name */
    private final ScheduledExecutorService f6693k;

    /* JADX INFO: Access modifiers changed from: package-private */
    public o(ExecutorService executorService, ScheduledExecutorService scheduledExecutorService) {
        this.f6692j = executorService;
        this.f6693k = scheduledExecutorService;
    }
    ...
    public /* synthetic */ void n(final Runnable runnable, final p.b bVar) {
        this.f6692j.execute(new Runnable() { // from class: com.google.firebase.concurrent.l
    ...
    public /* synthetic */ ScheduledFuture o(final Runnable runnable, long j10, TimeUnit timeUnit, final p.b bVar) {
        return this.f6693k.schedule(new Runnable() { // from class: com.google.firebase.concurrent.i
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ Future q(final Callable callable, final p.b bVar) {
        return this.f6692j.submit(new Runnable() { // from class: com.google.firebase.concurrent.d
            @Override // java.lang.Runnable
            public final void run() {
                o.p(callable, bVar);
            }
    ...
    public /* synthetic */ ScheduledFuture r(final Callable callable, long j10, TimeUnit timeUnit, final p.b bVar) {
        return this.f6693k.schedule(new Callable() { // from class: com.google.firebase.concurrent.e
    ...
    public /* synthetic */ void t(final Runnable runnable, final p.b bVar) {
        this.f6692j.execute(new Runnable() { // from class: com.google.firebase.concurrent.m
            @Override // java.lang.Runnable
            public final void run() {
                o.s(runnable, bVar);
            }
    ...
    public /* synthetic */ ScheduledFuture u(final Runnable runnable, long j10, long j11, TimeUnit timeUnit, final p.b bVar) {
        return this.f6693k.scheduleAtFixedRate(new Runnable() { // from class: com.google.firebase.concurrent.j
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void v(final Runnable runnable, final p.b bVar) {
        this.f6692j.execute(new Runnable() { // from class: com.google.firebase.concurrent.n
            @Override // java.lang.Runnable
            public final void run() {
                o.x(runnable, bVar);
            }
    ...
    public /* synthetic */ ScheduledFuture w(final Runnable runnable, long j10, long j11, TimeUnit timeUnit, final p.b bVar) {
        return this.f6693k.scheduleWithFixedDelay(new Runnable() { // from class: com.google.firebase.concurrent.k
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public boolean awaitTermination(long j10, TimeUnit timeUnit) {
        return this.f6692j.awaitTermination(j10, timeUnit);
    }

    @Override // java.util.concurrent.Executor
    public void execute(Runnable runnable) {
        this.f6692j.execute(runnable);
    }

    @Override // java.util.concurrent.ExecutorService
    public <T> List<Future<T>> invokeAll(Collection<? extends Callable<T>> collection) {
        return this.f6692j.invokeAll(collection);
    }

    @Override // java.util.concurrent.ExecutorService
    public <T> List<Future<T>> invokeAll(Collection<? extends Callable<T>> collection, long j10, TimeUnit timeUnit) {
        return this.f6692j.invokeAll(collection, j10, timeUnit);
    }

    @Override // java.util.concurrent.ExecutorService
    public <T> T invokeAny(Collection<? extends Callable<T>> collection) {
        return (T) this.f6692j.invokeAny(collection);
    }

    @Override // java.util.concurrent.ExecutorService
    public <T> T invokeAny(Collection<? extends Callable<T>> collection, long j10, TimeUnit timeUnit) {
        return (T) this.f6692j.invokeAny(collection, j10, timeUnit);
    }

    @Override // java.util.concurrent.ExecutorService
    public boolean isShutdown() {
        return this.f6692j.isShutdown();
    }

    @Override // java.util.concurrent.ExecutorService
    public boolean isTerminated() {
        return this.f6692j.isTerminated();
    }
    ...
    public Future<?> submit(Runnable runnable) {
        return this.f6692j.submit(runnable);
    }

    @Override // java.util.concurrent.ExecutorService
    public <T> Future<T> submit(Runnable runnable, T t10) {
        return this.f6692j.submit(runnable, t10);
    }

    @Override // java.util.concurrent.ExecutorService
    public <T> Future<T> submit(Callable<T> callable) {
        return this.f6692j.submit(callable);
    }
}
