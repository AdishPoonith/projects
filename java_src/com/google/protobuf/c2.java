...
public interface c2 {
    ...
    void J(int i10, List<?> list, n1 n1Var);

    @Deprecated
    void K(int i10, List<?> list, n1 n1Var);

    @Deprecated
    void L(int i10, Object obj, n1 n1Var);

    void M(int i10, i iVar);

    void N(int i10, Object obj, n1 n1Var);

    <K, V> void O(int i10, o0.a<K, V> aVar, Map<K, V> map);
