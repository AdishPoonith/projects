...
public final class i {
    ...
    static final SparseArray f4707a;
    ...
    */
    public static w5.l a(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instructions count: 540
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p000firebaseauthapi.i.a(com.google.android.gms.common.api.Status):w5.l");
    }

    public static l b(Status status, h hVar, String str, String str2) {
        int C = status.C();
        if (C == 17012 || C == 17007 || C == 17025) {
            x xVar = new x(c(C), d(e(C), status));
            xVar.d(hVar);
            xVar.e(str);
            xVar.f(str2);
            return xVar;
    ...
    private static String d(String str, Status status) {
        ...
        return String.format(String.valueOf(str).concat(" [ %s ]"), status.D());
    }
