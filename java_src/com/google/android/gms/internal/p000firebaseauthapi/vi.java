...
/* renamed from: com.google.android.gms.internal.firebase-auth-api.vi  reason: invalid package */
/* loaded from: classes.dex */
public final class vi {

    /* renamed from: a  reason: collision with root package name */
    private static final int[] f5537a = {0, 3, 6, 9, 12, 16, 19, 22, 25, 28};

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f5538b = {0, 2, 3, 5, 6, 0, 1, 3, 4, 6};

    /* renamed from: c  reason: collision with root package name */
    private static final int[] f5539c = {67108863, 33554431};

    /* renamed from: d  reason: collision with root package name */
    private static final int[] f5540d = {26, 25};
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void f(long[] jArr, long[] jArr2, long j10) {
    ...
    public static byte[] j(long[] jArr) {
        ...
        while (true) {
            ...
            while (i20 < 9) {
                long j12 = copyOf[i20];
                copyOf[i20] = j12 + (i18 << i17);
                i20++;
                copyOf[i20] = copyOf[i20] - (-((int) (((j12 >> 31) & j12) >> f5540d[i20 & 1])));
            }
            long j13 = copyOf[9];
            copyOf[9] = j13 + (i16 << 25);
        ...
        int i21 = 0;
        for (i10 = 2; i21 < i10; i10 = 2) {
            int i22 = 0;
            while (i22 < 9) {
                long j15 = copyOf[i22];
                long j16 = j15 >> f5540d[i22 & 1];
                copyOf[i22] = j15 & f5539c[i15];
                i22++;
                copyOf[i22] = copyOf[i22] + ((int) j16);
            }
            i21++;
        }
        ...
        for (int i24 = 1; i24 < 10; i24++) {
            int i25 = ~(f5539c[i24 & 1] ^ ((int) copyOf[i24]));
            int i26 = i25 & (i25 << 16);
            int i27 = i26 & (i26 << 8);
            int i28 = i27 & (i27 << 4);
            int i29 = i28 & (i28 << 2);
        ...
        for (int i30 = 2; i30 < 10; i30 += 2) {
            ...
            int i31 = i30 + 1;
            copyOf[i31] = copyOf[i31] - j17;
        }
        for (int i32 = 0; i32 < 10; i32++) {
            copyOf[i32] = copyOf[i32] << f5538b[i32];
        }
        ...
        for (int i33 = 0; i33 < 10; i33++) {
            ...
            int i34 = iArr[i33];
            long j18 = copyOf[i33];
            bArr[i34] = (byte) (bArr[i34] | (j18 & 255));
            bArr[iArr[i33] + 1] = (byte) (bArr[i12] | ((j18 >> 8) & 255));
            bArr[iArr[i33] + 2] = (byte) (bArr[i13] | ((j18 >> 16) & 255));
            bArr[iArr[i33] + 3] = (byte) (((j18 >> 24) & 255) | bArr[i14]);
        }
        return bArr;
    }
    ...
    public static long[] k(byte[] bArr) {
        ...
        for (int i10 = 0; i10 < 10; i10++) {
            int i11 = f5537a[i10];
            jArr[i10] = (((((bArr[i11] & 255) | ((bArr[i11 + 1] & 255) << 8)) | ((bArr[i11 + 2] & 255) << 16)) | ((bArr[i11 + 3] & 255) << 24)) >> f5538b[i10]) & f5539c[i10 & 1];
        }
        return jArr;
    }
}
