...
public final class zzah {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:11:0x003f, code lost:
        if (r2 == (-1)) goto L9;
     */
    /* JADX WARN: Removed duplicated region for block: B:15:0x0046 A[Catch: NameNotFoundException -> 0x0085, TryCatch #0 {NameNotFoundException -> 0x0085, blocks: (B:13:0x0042, B:15:0x0046, B:16:0x0058, B:19:0x0066, B:20:0x0073), top: B:25:0x0042 }] */
    ...
    */
    private static final com.google.android.recaptcha.internal.zzkj zzd(android.content.Context r8) {
        ...
        L41:
            r2 = r0
        L42:
            int r3 = android.os.Build.VERSION.SDK_INT     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            if (r3 < r1) goto L61
            android.content.pm.PackageManager r1 = r8.getPackageManager()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            java.lang.String r8 = r8.getPackageName()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            r3 = 0
            android.content.pm.PackageManager$PackageInfoFlags r3 = android.content.pm.PackageManager.PackageInfoFlags.of(r3)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            android.content.pm.PackageInfo r8 = r1.getPackageInfo(r8, r3)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
        L58:
            long r3 = r8.getLongVersionCode()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            java.lang.String r0 = java.lang.String.valueOf(r3)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            goto L85
        L61:
            r1 = 28
            r4 = 0
            ...
            android.content.pm.PackageManager r1 = r8.getPackageManager()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            java.lang.String r8 = r8.getPackageName()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            android.content.pm.PackageInfo r8 = r1.getPackageInfo(r8, r4)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            goto L58
        L73:
            android.content.pm.PackageManager r1 = r8.getPackageManager()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            java.lang.String r8 = r8.getPackageName()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            android.content.pm.PackageInfo r8 = r1.getPackageInfo(r8, r4)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            int r8 = r8.versionCode     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
            java.lang.String r0 = java.lang.String.valueOf(r8)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L85
        L85:
