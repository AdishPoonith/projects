...
public final class g<T> {
    ...
    private final c<T> f3014b;

    /* loaded from: classes.dex */
    private static class b implements c<Context> {

        /* renamed from: a  reason: collision with root package name */
        private final Class<? extends Service> f3015a;
        ...
        private Bundle b(Context context) {
            try {
                ...
                ServiceInfo serviceInfo = packageManager.getServiceInfo(new ComponentName(context, this.f3015a), 128);
                if (serviceInfo == null) {
                    Log.w("ComponentDiscovery", this.f3015a + " has no service info.");
                    return null;
                }
    ...
    public List<s6.b<ComponentRegistrar>> b() {
        ArrayList arrayList = new ArrayList();
        for (final String str : this.f3014b.a(this.f3013a)) {
            arrayList.add(new s6.b() { // from class: b6.f
                @Override // s6.b
