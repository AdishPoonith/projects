...
public class d {
    ...
    public static class a implements TypeEvaluator<c.b[]> {
        ...
        /* renamed from: a */
        public c.b[] evaluate(float f10, c.b[] bVarArr, c.b[] bVarArr2) {
            if (androidx.core.graphics.c.b(bVarArr, bVarArr2)) {
                if (!androidx.core.graphics.c.b(this.f2751a, bVarArr)) {
                    this.f2751a = androidx.core.graphics.c.f(bVarArr);
                }
                for (int i10 = 0; i10 < bVarArr.length; i10++) {
                    this.f2751a[i10].d(bVarArr[i10], bVarArr2[i10], f10);
                }
                return this.f2751a;
            }
    ...
    */
    ...
    private static PropertyValuesHolder e(TypedArray typedArray, int i10, int i11, int i12, String str) {
        ...
        c.b[] d10 = androidx.core.graphics.c.d(string);
        c.b[] d11 = androidx.core.graphics.c.d(string2);
        ...
        } else if (!androidx.core.graphics.c.b(d10, d11)) {
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k10 = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f2735j);
        int i10 = 0;
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f10, XmlPullParser xmlPullParser) {
        TypedArray k10 = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f2732g);
        TypedArray k11 = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f2736k);
    ...
    private static PropertyValuesHolder[] p(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, AttributeSet attributeSet) {
        ...
        while (true) {
            ...
            if (eventType == 2 && xmlPullParser.getName().equals("propertyValuesHolder")) {
                TypedArray k10 = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f2734i);
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i10, float f10, XmlPullParser xmlPullParser) {
        ...
        if (i12 != null || i13 != null) {
            s(androidx.core.graphics.c.e(i11), objectAnimator, f10 * 0.5f, i12, i13);
            return;
        }
