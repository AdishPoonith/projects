...
public class a {
    ...
    private final float f1642e;

    /* renamed from: f  reason: collision with root package name */
    private final float f1643f;

    /* renamed from: g  reason: collision with root package name */
    private final float f1644g;

    /* renamed from: h  reason: collision with root package name */
    private final float f1645h;

    /* renamed from: i  reason: collision with root package name */
    private final float f1646i;
    ...
    int o(l lVar) {
        ...
        float[][] fArr = b.f1648b;
        return androidx.core.graphics.a.a((fArr[0][0] * f18) + (fArr[0][1] * f19) + (fArr[0][2] * f20), (fArr[1][0] * f18) + (fArr[1][1] * f19) + (fArr[1][2] * f20), (f18 * fArr[2][0]) + (f19 * fArr[2][1]) + (f20 * fArr[2][2]));
    }
