...
public final class h {
    ...
    private static final ThreadLocal<TypedValue> f1668a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    private static final WeakHashMap<d, SparseArray<c>> f1669b = new WeakHashMap<>(0);
    ...
    public static class c {
        ...
        /* renamed from: a  reason: collision with root package name */
        final ColorStateList f1671a;

        /* renamed from: b  reason: collision with root package name */
        final Configuration f1672b;

        /* renamed from: c  reason: collision with root package name */
        final int f1673c;

        c(ColorStateList colorStateList, Configuration configuration, Resources.Theme theme) {
            this.f1671a = colorStateList;
            this.f1672b = configuration;
            this.f1673c = theme == null ? 0 : theme.hashCode();
        }
    }
    ...
    public static final class d {
        ...
        /* renamed from: a  reason: collision with root package name */
        final Resources f1674a;

        /* renamed from: b  reason: collision with root package name */
        final Resources.Theme f1675b;
        ...
        public boolean equals(Object obj) {
            ...
            d dVar = (d) obj;
            return this.f1674a.equals(dVar.f1674a) && androidx.core.util.c.a(this.f1675b, dVar.f1675b);
        }

        public int hashCode() {
            return androidx.core.util.c.b(this.f1674a, this.f1675b);
        }
    }
    ...
    private static void a(d dVar, int i10, ColorStateList colorStateList, Resources.Theme theme) {
        synchronized (f1670c) {
            WeakHashMap<d, SparseArray<c>> weakHashMap = f1669b;
            SparseArray<c> sparseArray = weakHashMap.get(dVar);
            if (sparseArray == null) {
                sparseArray = new SparseArray<>();
                weakHashMap.put(dVar, sparseArray);
            }
            sparseArray.append(i10, new c(colorStateList, dVar.f1674a.getConfiguration(), theme));
        }
    }
    ...
    private static ColorStateList b(d dVar, int i10) {
        ...
        synchronized (f1670c) {
            SparseArray<c> sparseArray = f1669b.get(dVar);
            if (sparseArray != null && sparseArray.size() > 0 && (cVar = sparseArray.get(i10)) != null) {
                if (cVar.f1672b.equals(dVar.f1674a.getConfiguration()) && (((theme = dVar.f1675b) == null && cVar.f1673c == 0) || (theme != null && cVar.f1673c == theme.hashCode()))) {
                    return cVar.f1671a;
                }
    ...
    private static TypedValue f() {
        ThreadLocal<TypedValue> threadLocal = f1668a;
