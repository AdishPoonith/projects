...
public final class c {
    ...
    private static final ThreadLocal<TypedValue> f1651a = new ThreadLocal<>();
    ...
    private static TypedValue c() {
        ThreadLocal<TypedValue> threadLocal = f1651a;
    ...
    */
    ...
    private static int g(int i10, float f10, float f11) {
        ...
        if (f10 != 1.0f || z10) {
            int a10 = v.a.a((int) ((Color.alpha(i10) * f10) + 0.5f), 0, 255);
            if (z10) {
                a c10 = a.c(i10);
