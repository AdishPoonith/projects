...
public final class e {
    ...
    private static final byte[] f15347a = {0, 0, 0, 1};

    /* renamed from: b  reason: collision with root package name */
    private static final String[] f15348b = {"", "A", "B", "C"};
    ...
    public static String c(int i10, boolean z10, int i11, int i12, int[] iArr, int i13) {
        ...
        objArr[0] = f15348b[i10];
        objArr[1] = Integer.valueOf(i11);
        objArr[2] = Integer.valueOf(i12);
        objArr[3] = Character.valueOf(z10 ? 'H' : 'L');
        objArr[4] = Integer.valueOf(i13);
        StringBuilder sb = new StringBuilder(n0.C("hvc1.%s%d.%X.%c%d", objArr));
    ...
    private static int e(byte[] bArr, int i10) {
        int length = bArr.length - f15347a.length;
        while (i10 <= length) {
            if (f(bArr, i10)) {
                return i10;
            }
    ...
    private static boolean f(byte[] bArr, int i10) {
        if (bArr.length - i10 <= f15347a.length) {
            return false;
        }
        int i11 = 0;
        while (true) {
