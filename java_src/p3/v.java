...
public final class v {
    ...
    private static final ArrayList<a> f15436a = new ArrayList<>();

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f15437b = Pattern.compile("^mp4a\\.([a-zA-Z0-9]{2})(?:\\.([0-9]{1,2}))?$");
    ...
    private static String e(String str) {
        int size = f15436a.size();
        for (int i10 = 0; i10 < size; i10++) {
            a aVar = f15436a.get(i10);
            if (str.startsWith(aVar.f15439b)) {
                return aVar.f15438a;
            }
        }
        return null;
