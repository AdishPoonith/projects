...
.field private static final c:Lq0/c0;
...
.method private final a(Ljava/lang/String;Ljava/lang/String;)Ly0/i$a;
    .locals 1
    ...
    invoke-direct {p0, p1, p2, v0}, Ly0/i;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Ly0/i$a;
...
.method private final b(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Ly0/i$a;
    .locals 6
    ...
    invoke-direct {p3, v0, p1, p2}, Ly0/i$a;-><init>(Ljava/math/BigDecimal;Ljava/util/Currency;Landroid/os/Bundle;)V
    :try_end_0
    ...
    sget-object p2, Ly0/i;->b:Ljava/lang/String;
...
.method public static final d()V
    ...
    invoke-virtual {v2, v0, v1}, Lq0/o$a;->a(Landroid/app/Application;Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    sget-object v0, Ly0/i;->b:Ljava/lang/String;
...
.method public static final e(Ljava/lang/String;J)V
    ...
    invoke-direct {v1, v0}, Lq0/c0;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, p2, p0, p1, v0}, Lq0/c0;->c(Ljava/lang/String;DLandroid/os/Bundle;)V
...
.method public static final f(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    :cond_0
    invoke-direct {v0, p0, p1}, Ly0/i;->a(Ljava/lang/String;Ljava/lang/String;)Ly0/i$a;
    ...
    invoke-static {v1, p2, v0}, Lf1/q;->d(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    sget-object p2, Lw0/i;->a:Lw0/i;

    invoke-virtual {p2, p1}, Lw0/i;->m(Ljava/lang/String;)Z
    ...
    :goto_0
    sget-object p2, Ly0/i;->c:Lq0/c0;

    invoke-virtual {p0}, Ly0/i$a;->c()Ljava/math/BigDecimal;

    move-result-object v0

    invoke-virtual {p0}, Ly0/i$a;->a()Ljava/util/Currency;

    move-result-object v1

    invoke-virtual {p0}, Ly0/i$a;->b()Landroid/os/Bundle;

    move-result-object p0

    invoke-virtual {p2, p1, v0, v1, p0}, Lq0/c0;->i(Ljava/lang/String;Ljava/math/BigDecimal;Ljava/util/Currency;Landroid/os/Bundle;)V

    goto :goto_1

    :cond_4
    sget-object p1, Ly0/i;->c:Lq0/c0;
    ...
    invoke-virtual {p1, p2, v0, p0}, Lq0/c0;->j(Ljava/math/BigDecimal;Ljava/util/Currency;Landroid/os/Bundle;)V
