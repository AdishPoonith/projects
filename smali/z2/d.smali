...
.method private static b(ILjava/util/List;)V
    ...
    invoke-static {v0, p0}, Le5/e;->g([II)I
...
.method private d(ILs1/n1;Ljava/util/List;Lp3/j0;)Lx1/l;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    iget-object p2, p2, Ls1/n1;->l:Ljava/lang/String;

    invoke-direct {p1, p2, p4}, Lz2/t;-><init>(Ljava/lang/String;Lp3/j0;)V
    ...
    invoke-static {p1, v0, p2, p3, p4}, Lz2/d;->f(IZLs1/n1;Ljava/util/List;Lp3/j0;)Lh2/h0;
    ...
    :cond_2
    invoke-static {p4, p2, p3}, Lz2/d;->e(Lp3/j0;Ls1/n1;Ljava/util/List;)Lf2/g;
...
.method private static e(Lp3/j0;Ls1/n1;Ljava/util/List;)Lf2/g;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1}, Lz2/d;->g(Ls1/n1;)Z
    ...
    :goto_1
    invoke-direct {v0, p1, p0, v1, p2}, Lf2/g;-><init>(ILp3/j0;Lf2/o;Ljava/util/List;)V

    return-object v0
.end method

.method private static f(IZLs1/n1;Ljava/util/List;Lp3/j0;)Lh2/h0;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IZ",
    ...
    invoke-virtual {p1, p3}, Ls1/n1$b;->g0(Ljava/lang/String;)Ls1/n1$b;
    ...
    :goto_0
    iget-object p1, p2, Ls1/n1;->r:Ljava/lang/String;
    ...
    invoke-direct {p1, p0, p4, p2}, Lh2/h0;-><init>(ILp3/j0;Lh2/i0$c;)V

    return-object p1
.end method

.method private static g(Ls1/n1;)Z
    .locals 4
    ...
    iget-object p0, v2, Lz2/q;->l:Ljava/util/List;
...
# virtual methods
.method public bridge synthetic a(Landroid/net/Uri;Ls1/n1;Ljava/util/List;Lp3/j0;Ljava/util/Map;Lx1/m;Lt1/t1;)Lz2/j;
    .locals 0

    invoke-virtual/range {p0 .. p7}, Lz2/d;->c(Landroid/net/Uri;Ls1/n1;Ljava/util/List;Lp3/j0;Ljava/util/Map;Lx1/m;Lt1/t1;)Lz2/b;
...
.method public c(Landroid/net/Uri;Ls1/n1;Ljava/util/List;Lp3/j0;Ljava/util/Map;Lx1/m;Lt1/t1;)Lz2/b;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p7, p2, Ls1/n1;->u:Ljava/lang/String;
    ...
    invoke-direct {p0, v2, p2, p3, p4}, Lz2/d;->d(ILs1/n1;Ljava/util/List;Lp3/j0;)Lx1/l;
    ...
    invoke-direct {p1, v4, p2, p4}, Lz2/b;-><init>(Lx1/l;Ls1/n1;Lp3/j0;)V
    ...
    invoke-direct {p1, p3, p2, p4}, Lz2/b;-><init>(Lx1/l;Ls1/n1;Lp3/j0;)V
