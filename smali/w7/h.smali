...
.method public constructor <init>(Landroid/content/Context;Lw7/a;)V
    ...
    iput-object v0, p0, Lw7/h;->b:Ljava/security/SecureRandom;

    invoke-virtual {p0}, Lw7/h;->c()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lw7/h;->d()Ljavax/crypto/Cipher;

    move-result-object v3

    iput-object v3, p0, Lw7/h;->a:Ljavax/crypto/Cipher;
    ...
    invoke-interface {p2, p1, v3}, Lw7/a;->b([BLjava/lang/String;)Ljava/security/Key;

    move-result-object p1

    iput-object p1, p0, Lw7/h;->c:Ljava/security/Key;
    :try_end_0
    ...
    iget-object v4, p0, Lw7/h;->b:Ljava/security/SecureRandom;
    ...
    iput-object v4, p0, Lw7/h;->c:Ljava/security/Key;

    invoke-interface {p2, v4}, Lw7/a;->a(Ljava/security/Key;)[B
...
.method public a([B)[B
    ...
    invoke-virtual {p0}, Lw7/h;->e()I

    move-result v0

    new-array v1, v0, [B

    iget-object v2, p0, Lw7/h;->b:Ljava/security/SecureRandom;

    invoke-virtual {v2, v1}, Ljava/security/SecureRandom;->nextBytes([B)V

    invoke-virtual {p0, v1}, Lw7/h;->f([B)Ljava/security/spec/AlgorithmParameterSpec;

    move-result-object v2

    iget-object v3, p0, Lw7/h;->a:Ljavax/crypto/Cipher;

    iget-object v4, p0, Lw7/h;->c:Ljava/security/Key;

    const/4 v5, 0x1

    invoke-virtual {v3, v5, v4, v2}, Ljavax/crypto/Cipher;->init(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V

    iget-object v2, p0, Lw7/h;->a:Ljavax/crypto/Cipher;
...
.method public b([B)[B
    ...
    iget-object p1, p0, Lw7/h;->a:Ljavax/crypto/Cipher;

    iget-object v0, p0, Lw7/h;->c:Ljava/security/Key;
