...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lg8/a;->a:Ljava/lang/String;
    ...
    sput-object v1, Lg8/a;->b:Ljava/lang/String;
    ...
    sput-object v1, Lg8/a;->c:Ljava/lang/String;
...
.method private static c(Landroid/content/pm/ApplicationInfo;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v2}, Lg8/a;->g(Landroid/content/res/XmlResourceParser;Lorg/json/JSONArray;Z)V
...
.method public static e(Landroid/content/Context;)Lg8/b;
    .locals 10

    invoke-static {p0}, Lg8/a;->a(Landroid/content/Context;)Landroid/content/pm/ApplicationInfo;
    ...
    sget-object v2, Lg8/a;->a:Ljava/lang/String;

    invoke-static {v1, v2}, Lg8/a;->d(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iget-object v1, v0, Landroid/content/pm/ApplicationInfo;->metaData:Landroid/os/Bundle;

    sget-object v3, Lg8/a;->b:Ljava/lang/String;

    invoke-static {v1, v3}, Lg8/a;->d(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iget-object v1, v0, Landroid/content/pm/ApplicationInfo;->metaData:Landroid/os/Bundle;

    sget-object v4, Lg8/a;->c:Ljava/lang/String;

    invoke-static {v1, v4}, Lg8/a;->d(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v1, v0, Landroid/content/pm/ApplicationInfo;->metaData:Landroid/os/Bundle;

    sget-object v5, Lg8/a;->d:Ljava/lang/String;

    invoke-static {v1, v5}, Lg8/a;->d(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-static {v0, p0}, Lg8/a;->c(Landroid/content/pm/ApplicationInfo;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Lg8/a;->b(Landroid/os/Bundle;Ljava/lang/String;Z)Z

    move-result v8

    move-object v1, v9

    invoke-direct/range {v1 .. v8}, Lg8/b;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
...
.method private static g(Landroid/content/res/XmlResourceParser;Lorg/json/JSONArray;Z)V
    ...
    invoke-static {p0, p1, p2}, Lg8/a;->f(Landroid/content/res/XmlResourceParser;Lorg/json/JSONArray;Z)V
    ...
    invoke-static {p0, p1, p2}, Lg8/a;->g(Landroid/content/res/XmlResourceParser;Lorg/json/JSONArray;Z)V

    goto :goto_0

    :cond_2
    invoke-static {p0}, Lg8/a;->h(Landroid/content/res/XmlResourceParser;)V
