...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lb4/j;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lb4/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, p0, p1}, Lb4/f;->g(Landroid/content/Context;I)I
    ...
    invoke-virtual {v0, p0, p1, v1}, Lb4/f;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {p0, p1}, Lb4/g;-><init>(I)V
    ...
    invoke-direct {v0, p1, v1, p0}, Lb4/h;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static b(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lb4/b;->G(I)Ljava/lang/String;
...
.method public static e(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {p0}, Lj4/c;->a(Landroid/content/Context;)Lj4/b;
    ...
    invoke-virtual {v0, v3, v4}, Lj4/b;->c(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;

    move-result-object v0

    invoke-static {p0}, Lb4/k;->a(Landroid/content/Context;)Lb4/k;

    if-eqz v0, :cond_0

    invoke-static {v0, v1}, Lb4/k;->d(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Lb4/k;->d(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Lb4/j;->c:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Lb4/j;->c:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_1
    :goto_2
    sget-boolean p0, Lb4/j;->c:Z

    if-nez p0, :cond_3

    invoke-static {}, Lh4/g;->b()Z
...
.method public static f(Landroid/content/Context;I)I
    ...
    sget-object v1, Lb4/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    invoke-static {p0}, Lc4/z0;->a(Landroid/content/Context;)I
    ...
    :cond_3
    :goto_1
    invoke-static {p0}, Lh4/g;->d(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lh4/g;->f(Landroid/content/Context;)Z
    ...
    invoke-static {v9, v3}, Lb4/k;->d(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v8, v3}, Lb4/k;->d(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Lh4/o;->a(I)I

    move-result p0

    invoke-static {p1}, Lh4/o;->a(I)I
...
.method public static g(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lb4/j;->j(Landroid/content/Context;Ljava/lang/String;)Z
...
.method static j(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lb4/j;->h(Landroid/content/Context;)Z
