...
.field private static final k:Li9/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Li9/g<",
            "Ljava/lang/Object;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/grpc/internal/z;->k:Li9/g;

    return-void
.end method

.method protected constructor <init>(Ljava/util/concurrent/Executor;Ljava/util/concurrent/ScheduledExecutorService;Li9/t;)V
    .locals 1
    ...
    iput-object p1, p0, Lio/grpc/internal/z;->c:Li9/r;

    invoke-direct {p0, p2, p3}, Lio/grpc/internal/z;->o(Ljava/util/concurrent/ScheduledExecutorService;Li9/t;)Ljava/util/concurrent/ScheduledFuture;
...
.method static synthetic f(Lio/grpc/internal/z;Li9/j1;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/grpc/internal/z;->k(Li9/j1;Z)V
...
.method static synthetic h(Lio/grpc/internal/z;)Li9/g;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/z;->f:Li9/g;

    return-object p0
.end method

.method static synthetic i(Lio/grpc/internal/z;)Li9/r;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/z;->c:Li9/r;

    return-object p0
.end method

.method private k(Li9/j1;Z)V
    .locals 2

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lio/grpc/internal/z;->f:Li9/g;

    if-nez v0, :cond_0

    sget-object p2, Lio/grpc/internal/z;->k:Li9/g;

    invoke-direct {p0, p2}, Lio/grpc/internal/z;->q(Li9/g;)V

    const/4 p2, 0x0

    iget-object v0, p0, Lio/grpc/internal/z;->e:Li9/g$a;

    iput-object p1, p0, Lio/grpc/internal/z;->g:Li9/j1;
    ...
    invoke-direct {p2, p0, p1}, Lio/grpc/internal/z$e;-><init>(Lio/grpc/internal/z;Li9/j1;)V
    ...
    invoke-direct {v1, p0, v0, p1}, Lio/grpc/internal/z$j;-><init>(Lio/grpc/internal/z;Li9/g$a;Li9/j1;)V
...
.method private n(Li9/t;Li9/t;)Z
    .locals 0
    ...
    :cond_1
    invoke-virtual {p1, p2}, Li9/t;->l(Li9/t;)Z
...
.method private o(Ljava/util/concurrent/ScheduledExecutorService;Li9/t;)Ljava/util/concurrent/ScheduledFuture;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lio/grpc/internal/z;->c:Li9/r;

    invoke-virtual {v0}, Li9/r;->g()Li9/t;
    ...
    invoke-virtual {p2, v1}, Li9/t;->p(Ljava/util/concurrent/TimeUnit;)J
    ...
    invoke-virtual {v0, v5}, Li9/t;->p(Ljava/util/concurrent/TimeUnit;)J
    ...
    :cond_2
    invoke-virtual {p2, v5}, Li9/t;->p(Ljava/util/concurrent/TimeUnit;)J
    ...
    invoke-direct {p0, v0, p2}, Lio/grpc/internal/z;->n(Li9/t;Li9/t;)Z
...
.method private q(Li9/g;)V
    ...
    invoke-static {v2, v3, v0}, Lb5/n;->w(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_1
    iput-object p1, p0, Lio/grpc/internal/z;->f:Li9/g;
...
.method public final e(Li9/g$a;Li9/y0;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v0, Li9/g$a;

    iput-object v0, p0, Lio/grpc/internal/z;->e:Li9/g$a;

    iget-object v0, p0, Lio/grpc/internal/z;->g:Li9/j1;
    ...
    invoke-direct {v2, p1}, Lio/grpc/internal/z$k;-><init>(Li9/g$a;)V
    ...
    invoke-direct {v1, p0, p1, v0}, Lio/grpc/internal/z$j;-><init>(Lio/grpc/internal/z;Li9/g$a;Li9/j1;)V
    ...
    invoke-direct {v0, p0, p1, p2}, Lio/grpc/internal/z$d;-><init>(Lio/grpc/internal/z;Li9/g$a;Li9/y0;)V
...
.method public final p(Li9/g;)Ljava/lang/Runnable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1}, Lio/grpc/internal/z;->q(Li9/g;)V
    ...
    invoke-direct {p1, p0, v0}, Lio/grpc/internal/z$a;-><init>(Lio/grpc/internal/z;Li9/r;)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/grpc/internal/z;->f:Li9/g;
