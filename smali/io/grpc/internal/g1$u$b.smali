...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lio/grpc/internal/g1$u;->c(Li9/a1$g;)V
.end annotation
...
# instance fields
.field final synthetic j:Li9/a1$g;

.field final synthetic k:Lio/grpc/internal/g1$u;


# direct methods
.method constructor <init>(Lio/grpc/internal/g1$u;Li9/a1$g;)V
    .locals 0
    ...
    iput-object p1, p0, Lio/grpc/internal/g1$u$b;->k:Lio/grpc/internal/g1$u;

    iput-object p2, p0, Lio/grpc/internal/g1$u$b;->j:Li9/a1$g;
...
.method public run()V
    ...
    iget-object v0, p0, Lio/grpc/internal/g1$u$b;->k:Lio/grpc/internal/g1$u;

    iget-object v0, v0, Lio/grpc/internal/g1$u;->c:Lio/grpc/internal/g1;

    invoke-static {v0}, Lio/grpc/internal/g1;->l0(Lio/grpc/internal/g1;)Li9/a1;

    move-result-object v0

    iget-object v1, p0, Lio/grpc/internal/g1$u$b;->k:Lio/grpc/internal/g1$u;

    iget-object v1, v1, Lio/grpc/internal/g1$u;->b:Li9/a1;
    ...
    :cond_0
    iget-object v0, p0, Lio/grpc/internal/g1$u$b;->j:Li9/a1$g;

    invoke-virtual {v0}, Li9/a1$g;->a()Ljava/util/List;
    ...
    invoke-static {v1}, Lio/grpc/internal/g1;->F(Lio/grpc/internal/g1;)Li9/f;

    move-result-object v1

    sget-object v2, Li9/f$a;->j:Li9/f$a;
    ...
    iget-object v5, p0, Lio/grpc/internal/g1$u$b;->j:Li9/a1$g;

    invoke-virtual {v5}, Li9/a1$g;->b()Li9/a;
    ...
    invoke-virtual {v1, v2, v5, v3}, Li9/f;->b(Li9/f$a;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    sget-object v3, Lio/grpc/internal/g1$w;->k:Lio/grpc/internal/g1$w;
    ...
    sget-object v5, Li9/f$a;->k:Li9/f$a;
    ...
    invoke-virtual {v1, v5, v8, v7}, Li9/f;->b(Li9/f$a;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lio/grpc/internal/g1$u$b;->j:Li9/a1$g;

    invoke-virtual {v1}, Li9/a1$g;->c()Li9/a1$c;
    ...
    sget-object v7, Li9/f0;->a:Li9/a$c;

    invoke-virtual {v5, v7}, Li9/a;->b(Li9/a$c;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Li9/f0;

    if-eqz v1, :cond_2

    invoke-virtual {v1}, Li9/a1$c;->c()Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Li9/a1$c;->d()Li9/j1;
    ...
    :goto_1
    iget-object v9, p0, Lio/grpc/internal/g1$u$b;->k:Lio/grpc/internal/g1$u;
    ...
    iget-object v2, p0, Lio/grpc/internal/g1$u$b;->k:Lio/grpc/internal/g1$u;

    iget-object v2, v2, Lio/grpc/internal/g1$u;->c:Lio/grpc/internal/g1;

    invoke-static {v2}, Lio/grpc/internal/g1;->F(Lio/grpc/internal/g1;)Li9/f;
    ...
    invoke-virtual {v2, v3, v4}, Li9/f;->a(Li9/f$a;Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lio/grpc/internal/j1;->c()Li9/f0;

    move-result-object v3

    invoke-virtual {v2, v3}, Lio/grpc/internal/g1$v;->p(Li9/f0;)V
    ...
    invoke-virtual {v1, v5}, Lio/grpc/internal/g1$v;->p(Li9/f0;)V

    invoke-virtual {v7}, Lio/grpc/internal/j1;->c()Li9/f0;
    ...
    invoke-virtual {v1, v2}, Lio/grpc/internal/g1$v;->p(Li9/f0;)V
    ...
    invoke-virtual {v0, v2, v3}, Li9/f;->a(Li9/f$a;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lio/grpc/internal/g1$u;->b(Li9/j1;)V
    ...
    invoke-virtual {v1, v3}, Lio/grpc/internal/g1$v;->p(Li9/f0;)V
    ...
    invoke-virtual {v1, v2, v4, v3}, Li9/f;->b(Li9/f$a;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v5, p0, Lio/grpc/internal/g1$u$b;->k:Lio/grpc/internal/g1$u;

    iget-object v5, v5, Lio/grpc/internal/g1$u;->c:Lio/grpc/internal/g1;

    invoke-virtual {v5}, Lio/grpc/internal/g1;->f()Li9/j0;
    ...
    :goto_7
    iget-object v2, p0, Lio/grpc/internal/g1$u$b;->j:Li9/a1$g;

    invoke-virtual {v2}, Li9/a1$g;->b()Li9/a;

    move-result-object v2

    iget-object v3, p0, Lio/grpc/internal/g1$u$b;->k:Lio/grpc/internal/g1$u;
    ...
    invoke-virtual {v2}, Li9/a;->d()Li9/a$b;

    move-result-object v2

    sget-object v3, Li9/f0;->a:Li9/a$c;

    invoke-virtual {v2, v3}, Li9/a$b;->c(Li9/a$c;)Li9/a$b;
    ...
    sget-object v4, Li9/r0;->b:Li9/a$c;

    invoke-virtual {v2, v4, v3}, Li9/a$b;->d(Li9/a$c;Ljava/lang/Object;)Li9/a$b;
    ...
    :cond_10
    invoke-virtual {v2}, Li9/a$b;->a()Li9/a;
    ...
    invoke-virtual {v4, v0}, Li9/r0$g$a;->b(Ljava/util/List;)Li9/r0$g$a;

    move-result-object v0

    invoke-virtual {v0, v2}, Li9/r0$g$a;->c(Li9/a;)Li9/r0$g$a;
    ...
    invoke-virtual {v0}, Li9/r0$g$a;->a()Li9/r0$g;

    move-result-object v0

    invoke-virtual {v3, v0}, Lio/grpc/internal/j$b;->e(Li9/r0$g;)Z
