...
.field private static final n:Lio/grpc/internal/d2$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/grpc/internal/d2;->m:Ljava/util/logging/Logger;

    invoke-static {}, Lio/grpc/internal/d2;->c()Lio/grpc/internal/d2$b;

    move-result-object v0

    sput-object v0, Lio/grpc/internal/d2;->n:Lio/grpc/internal/d2$b;
...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    iput-object v0, p0, Lio/grpc/internal/d2;->k:Ljava/util/Queue;

    const/4 v0, 0x0

    iput v0, p0, Lio/grpc/internal/d2;->l:I

    const-string v0, "\'executor\' must not be null."

    invoke-static {p1, v0}, Lb5/n;->o(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p1, p0, Lio/grpc/internal/d2;->j:Ljava/util/concurrent/Executor;
...
.method static synthetic a(Lio/grpc/internal/d2;)I
    ...
    iget p0, p0, Lio/grpc/internal/d2;->l:I
...
.method static synthetic b(Lio/grpc/internal/d2;I)I
    ...
    iput p1, p0, Lio/grpc/internal/d2;->l:I
...
.method private static c()Lio/grpc/internal/d2$b;
    ...
    sget-object v2, Lio/grpc/internal/d2;->m:Ljava/util/logging/Logger;
...
.method private d(Ljava/lang/Runnable;)V
    ...
    sget-object v0, Lio/grpc/internal/d2;->n:Lio/grpc/internal/d2$b;
    ...
    :try_start_0
    iget-object v0, p0, Lio/grpc/internal/d2;->j:Ljava/util/concurrent/Executor;
    ...
    iget-object v2, p0, Lio/grpc/internal/d2;->k:Ljava/util/Queue;

    invoke-interface {v2, p1}, Ljava/util/Queue;->remove(Ljava/lang/Object;)Z

    :cond_0
    sget-object p1, Lio/grpc/internal/d2;->n:Lio/grpc/internal/d2$b;
...
.method public execute(Ljava/lang/Runnable;)V
    ...
    iget-object v0, p0, Lio/grpc/internal/d2;->k:Ljava/util/Queue;
...
.method public run()V
    ...
    :try_start_0
    iget-object v1, p0, Lio/grpc/internal/d2;->j:Ljava/util/concurrent/Executor;

    :goto_0
    iget-object v2, p0, Lio/grpc/internal/d2;->j:Ljava/util/concurrent/Executor;
    ...
    :try_start_2
    sget-object v4, Lio/grpc/internal/d2;->m:Ljava/util/logging/Logger;
    ...
    :cond_0
    sget-object v1, Lio/grpc/internal/d2;->n:Lio/grpc/internal/d2$b;
    ...
    sget-object v2, Lio/grpc/internal/d2;->n:Lio/grpc/internal/d2$b;
