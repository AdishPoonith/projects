...
.field private j:Li9/j1;

.field private k:Li9/r0$i;

.field private l:J


# direct methods
.method constructor <init>(Ljava/util/concurrent/Executor;Li9/n1;)V
    .locals 2
    ...
    invoke-static {v0, v1}, Li9/j0;->a(Ljava/lang/Class;Ljava/lang/String;)Li9/j0;

    move-result-object v0

    iput-object v0, p0, Lio/grpc/internal/a0;->a:Li9/j0;
    ...
    iput-object p2, p0, Lio/grpc/internal/a0;->d:Li9/n1;

    return-void
.end method

.method static synthetic b(Lio/grpc/internal/a0;)Lio/grpc/internal/k1$a;
    .locals 0
...
.method static synthetic e(Lio/grpc/internal/a0;)Li9/j1;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/a0;->j:Li9/j1;
...
.method static synthetic n(Lio/grpc/internal/a0;)Li9/n1;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/a0;->d:Li9/n1;

    return-object p0
.end method

.method private o(Li9/r0$f;[Li9/k;)Lio/grpc/internal/a0$e;
    .locals 2
    ...
    invoke-direct {v0, p0, p1, p2, v1}, Lio/grpc/internal/a0$e;-><init>(Lio/grpc/internal/a0;Li9/r0$f;[Li9/k;Lio/grpc/internal/a0$a;)V
    ...
    iget-object p1, p0, Lio/grpc/internal/a0;->d:Li9/n1;

    iget-object p2, p0, Lio/grpc/internal/a0;->e:Ljava/lang/Runnable;

    invoke-virtual {p1, p2}, Li9/n1;->b(Ljava/lang/Runnable;)V
...
# virtual methods
.method public final a(Li9/z0;Li9/y0;Li9/c;[Li9/k;)Lio/grpc/internal/q;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2, p3}, Lio/grpc/internal/t1;-><init>(Li9/z0;Li9/y0;Li9/c;)V
    ...
    :try_start_1
    iget-object v3, p0, Lio/grpc/internal/a0;->j:Li9/j1;

    if-eqz v3, :cond_0

    new-instance p1, Lio/grpc/internal/f0;

    iget-object p3, p0, Lio/grpc/internal/a0;->j:Li9/j1;

    invoke-direct {p1, p3, p4}, Lio/grpc/internal/f0;-><init>(Li9/j1;[Li9/k;)V
    ...
    :goto_2
    iget-object p2, p0, Lio/grpc/internal/a0;->d:Li9/n1;

    invoke-virtual {p2}, Li9/n1;->a()V

    return-object p1

    :cond_0
    :try_start_2
    iget-object v3, p0, Lio/grpc/internal/a0;->k:Li9/r0$i;

    if-nez v3, :cond_1

    invoke-direct {p0, v0, p4}, Lio/grpc/internal/a0;->o(Li9/r0$f;[Li9/k;)Lio/grpc/internal/a0$e;
    ...
    :try_start_3
    invoke-virtual {v3, v0}, Li9/r0$i;->a(Li9/r0$f;)Li9/r0$e;

    move-result-object p1

    invoke-virtual {p3}, Li9/c;->j()Z

    move-result p2

    invoke-static {p1, p2}, Lio/grpc/internal/r0;->j(Li9/r0$e;Z)Lio/grpc/internal/s;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-virtual {v0}, Li9/r0$f;->c()Li9/z0;

    move-result-object p2

    invoke-virtual {v0}, Li9/r0$f;->b()Li9/y0;
    ...
    invoke-interface {p1, p2, p3, v0, p4}, Lio/grpc/internal/s;->a(Li9/z0;Li9/y0;Li9/c;[Li9/k;)Lio/grpc/internal/q;
...
.method public final c(Li9/j1;)V
    .locals 3
    ...
    :try_start_0
    iget-object v1, p0, Lio/grpc/internal/a0;->j:Li9/j1;
    ...
    :cond_0
    iput-object p1, p0, Lio/grpc/internal/a0;->j:Li9/j1;

    iget-object v1, p0, Lio/grpc/internal/a0;->d:Li9/n1;

    new-instance v2, Lio/grpc/internal/a0$d;

    invoke-direct {v2, p0, p1}, Lio/grpc/internal/a0$d;-><init>(Lio/grpc/internal/a0;Li9/j1;)V

    invoke-virtual {v1, v2}, Li9/n1;->b(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v1, p1}, Li9/n1;->b(Ljava/lang/Runnable;)V
...
.method public f()Li9/j0;
    ...
    iget-object v0, p0, Lio/grpc/internal/a0;->a:Li9/j0;

    return-object v0
.end method

.method public final g(Li9/j1;)V
    .locals 6

    invoke-virtual {p0, p1}, Lio/grpc/internal/a0;->c(Li9/j1;)V
    ...
    sget-object v4, Lio/grpc/internal/r$a;->k:Lio/grpc/internal/r$a;

    invoke-static {v1}, Lio/grpc/internal/a0$e;->y(Lio/grpc/internal/a0$e;)[Li9/k;

    move-result-object v5

    invoke-direct {v3, p1, v4, v5}, Lio/grpc/internal/f0;-><init>(Li9/j1;Lio/grpc/internal/r$a;[Li9/k;)V
    ...
    invoke-virtual {p1, v2}, Li9/n1;->execute(Ljava/lang/Runnable;)V
...
.method final r(Li9/r0$i;)V
    ...
    :try_start_0
    iput-object p1, p0, Lio/grpc/internal/a0;->k:Li9/r0$i;
    ...
    invoke-static {v2}, Lio/grpc/internal/a0$e;->z(Lio/grpc/internal/a0$e;)Li9/r0$f;

    move-result-object v3

    invoke-virtual {p1, v3}, Li9/r0$i;->a(Li9/r0$f;)Li9/r0$e;
    ...
    invoke-virtual {v4}, Li9/r0$f;->a()Li9/c;

    move-result-object v4

    invoke-virtual {v4}, Li9/c;->j()Z

    move-result v5

    invoke-static {v3, v5}, Lio/grpc/internal/r0;->j(Li9/r0$e;Z)Lio/grpc/internal/s;
    ...
    invoke-virtual {v4}, Li9/c;->e()Ljava/util/concurrent/Executor;
    ...
    invoke-virtual {v1, v0}, Li9/n1;->b(Ljava/lang/Runnable;)V
