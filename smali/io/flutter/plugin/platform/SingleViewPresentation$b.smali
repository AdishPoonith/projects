...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation$b;->j:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation$b;->k:Landroid/graphics/Rect;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v2, p0, Lio/flutter/plugin/platform/SingleViewPresentation$b;->j:Landroid/graphics/Rect;
    ...
    iget-object v6, p0, Lio/flutter/plugin/platform/SingleViewPresentation$b;->j:Landroid/graphics/Rect;

    iget v7, v1, Landroid/view/WindowManager$LayoutParams;->x:I

    iget v8, v1, Landroid/view/WindowManager$LayoutParams;->y:I

    iget-object v9, p0, Lio/flutter/plugin/platform/SingleViewPresentation$b;->k:Landroid/graphics/Rect;

    invoke-static/range {v3 .. v9}, Landroid/view/Gravity;->apply(IIILandroid/graphics/Rect;IILandroid/graphics/Rect;)V

    iget-object v1, p0, Lio/flutter/plugin/platform/SingleViewPresentation$b;->k:Landroid/graphics/Rect;
