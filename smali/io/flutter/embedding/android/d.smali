...
# instance fields
.field protected j:Lio/flutter/embedding/android/e;

.field private k:Landroidx/lifecycle/j;

.field private final l:Landroid/window/OnBackInvokedCallback;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Lf9/h;->d(I)I

    move-result v0

    sput v0, Lio/flutter/embedding/android/d;->m:I
...
.method public constructor <init>()V
    ...
    :goto_0
    iput-object v0, p0, Lio/flutter/embedding/android/d;->l:Landroid/window/OnBackInvokedCallback;

    new-instance v0, Landroidx/lifecycle/j;

    invoke-direct {v0, p0}, Landroidx/lifecycle/j;-><init>(Landroidx/lifecycle/i;)V

    iput-object v0, p0, Lio/flutter/embedding/android/d;->k:Landroidx/lifecycle/j;
...
.method private F()V
    ...
    sget-object v1, Lio/flutter/embedding/android/f;->k:Lio/flutter/embedding/android/f;
...
.method private G()Landroid/view/View;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/d;->j:Lio/flutter/embedding/android/e;

    sget v4, Lio/flutter/embedding/android/d;->m:I

    invoke-virtual {p0}, Lio/flutter/embedding/android/d;->y()Lio/flutter/embedding/android/v;

    move-result-object v1

    sget-object v2, Lio/flutter/embedding/android/v;->j:Lio/flutter/embedding/android/v;
...
.method private K()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v1, v2}, Ld8/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public B()Lio/flutter/embedding/android/y;
    .locals 2
    ...
    sget-object v1, Lio/flutter/embedding/android/f;->j:Lio/flutter/embedding/android/f;

    if-ne v0, v1, :cond_0

    sget-object v0, Lio/flutter/embedding/android/y;->j:Lio/flutter/embedding/android/y;

    goto :goto_0

    :cond_0
    sget-object v0, Lio/flutter/embedding/android/y;->k:Lio/flutter/embedding/android/y;

    :goto_0
    return-object v0
.end method

.method public C(Lio/flutter/embedding/android/i;)V
    .locals 0

    return-void
.end method

.method public D(Lio/flutter/embedding/engine/a;)V
    .locals 1
...
.method protected H()Lio/flutter/embedding/android/f;
    ...
    :cond_0
    sget-object v0, Lio/flutter/embedding/android/f;->j:Lio/flutter/embedding/android/f;
...
.method public M()V
    ...
    iget-object v2, p0, Lio/flutter/embedding/android/d;->l:Landroid/window/OnBackInvokedCallback;
...
.method public N()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/d;->j:Lio/flutter/embedding/android/e;
...
.method public Q()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/d;->l:Landroid/window/OnBackInvokedCallback;
...
.method public a()Landroidx/lifecycle/e;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/d;->k:Landroidx/lifecycle/j;
...
.method public m()Z
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/d;->o()Ljava/lang/String;

    move-result-object v2

    if-nez v2, :cond_1

    iget-object v2, p0, Lio/flutter/embedding/android/d;->j:Lio/flutter/embedding/android/e;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-object p1, p0, Lio/flutter/embedding/android/d;->k:Landroidx/lifecycle/j;
...
.method public t(Landroid/app/Activity;Lio/flutter/embedding/engine/a;)Lio/flutter/plugin/platform/c;
    .locals 1
    ...
    invoke-virtual {p2}, Lio/flutter/embedding/engine/a;->n()Lq8/i;

    move-result-object p2

    invoke-direct {p1, v0, p2, p0}, Lio/flutter/plugin/platform/c;-><init>(Landroid/app/Activity;Lq8/i;Lio/flutter/plugin/platform/c$d;)V

    return-object p1
.end method

.method public u(Lio/flutter/embedding/android/h;)V
    .locals 0
...
.method public y()Lio/flutter/embedding/android/v;
    .locals 2
    ...
    sget-object v0, Lio/flutter/embedding/android/v;->j:Lio/flutter/embedding/android/v;

    goto :goto_0

    :cond_0
    sget-object v0, Lio/flutter/embedding/android/v;->k:Lio/flutter/embedding/android/v;

    :goto_0
    return-object v0
.end method

.method public z()Lio/flutter/embedding/android/x;
    .locals 2
