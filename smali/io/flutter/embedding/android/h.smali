...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Z)V
    ...
    iput-boolean p1, p0, Lio/flutter/embedding/android/h;->k:Z

    iput-boolean p1, p0, Lio/flutter/embedding/android/h;->l:Z
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/h;->o:Landroid/view/SurfaceHolder$Callback;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/h;->p:Lp8/b;

    iput-boolean p3, p0, Lio/flutter/embedding/android/h;->j:Z
...
.method static synthetic b(Lio/flutter/embedding/android/h;)Z
    .locals 0

    iget-boolean p0, p0, Lio/flutter/embedding/android/h;->m:Z

    return p0
.end method

.method static synthetic c(Lio/flutter/embedding/android/h;)V
    .locals 0
...
.method static synthetic i(Lio/flutter/embedding/android/h;)Lp8/a;
    .locals 0

    iget-object p0, p0, Lio/flutter/embedding/android/h;->n:Lp8/a;
...
.method private j(II)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/h;->n:Lp8/a;
...
.method private k()V
    ...
    iget-boolean v2, p0, Lio/flutter/embedding/android/h;->l:Z

    invoke-virtual {v0, v1, v2}, Lp8/a;->u(Landroid/view/Surface;Z)V
...
.method private m()V
    ...
    iget-boolean v0, p0, Lio/flutter/embedding/android/h;->j:Z
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/h;->o:Landroid/view/SurfaceHolder$Callback;
...
.method public d()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/h;->n:Lp8/a;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lio/flutter/embedding/android/h;->l:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, Lio/flutter/embedding/android/h;->m:Z
...
.method public e()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/h;->p:Lp8/b;

    invoke-virtual {v0, v1}, Lp8/a;->q(Lp8/b;)V
...
.method public f(Lp8/a;)V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/h;->n:Lp8/a;
    ...
    iget-object v2, p0, Lio/flutter/embedding/android/h;->p:Lp8/b;

    invoke-virtual {v1, v2}, Lp8/a;->q(Lp8/b;)V

    :cond_0
    iput-object p1, p0, Lio/flutter/embedding/android/h;->n:Lp8/a;

    const/4 v1, 0x1

    iput-boolean v1, p0, Lio/flutter/embedding/android/h;->m:Z

    iget-object v1, p0, Lio/flutter/embedding/android/h;->p:Lp8/b;

    invoke-virtual {p1, v1}, Lp8/a;->g(Lp8/b;)V

    iget-boolean p1, p0, Lio/flutter/embedding/android/h;->k:Z
