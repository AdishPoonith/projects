...
# direct methods
.method constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Ll6/o;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ll6/y3;->a:Landroid/database/sqlite/SQLiteDatabase;

    iput-object p2, p0, Ll6/y3;->b:Ll6/o;
...
.method private A()V
    ...
    invoke-direct {v1, p0}, Ll6/q3;-><init>(Ll6/y3;)V

    invoke-direct {p0, v0, v1}, Ll6/y3;->N([Ljava/lang/String;Ljava/lang/Runnable;)V
...
.method private B()V
    ...
    new-instance v1, Ll6/v3;

    invoke-direct {v1, p0}, Ll6/v3;-><init>(Ll6/y3;)V
...
.method private C()V
    ...
    invoke-direct {v1, p0}, Ll6/g3;-><init>(Ll6/y3;)V
...
.method private D()V
    ...
    new-instance v1, Ll6/p3;

    invoke-direct {v1, p0}, Ll6/p3;-><init>(Ll6/y3;)V
...
.method private E()V
    ...
    invoke-direct {v1, p0}, Ll6/r3;-><init>(Ll6/y3;)V
    ...
    iget-object v1, p0, Ll6/y3;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    new-instance v2, Ll6/w3;

    invoke-direct {v2, v0, v1}, Ll6/w3;-><init>(Ll6/t0$a;Landroid/database/sqlite/SQLiteStatement;)V
    ...
    invoke-direct {v0, v1, v3}, Ll6/z2$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V

    new-instance v1, Ll6/k3;

    invoke-direct {v1, v2}, Ll6/k3;-><init>(Lq6/n;)V
    ...
    new-instance v1, Ll6/l3;

    invoke-direct {v1, v2}, Ll6/l3;-><init>(Lq6/n;)V
...
.method private F()V
    ...
    invoke-direct {v0, v1, v2}, Ll6/z2$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V

    new-instance v1, Ll6/x3;

    invoke-direct {v1, p0}, Ll6/x3;-><init>(Ll6/y3;)V
...
.method private G()V
    ...
    invoke-direct {p0, v0}, Ll6/y3;->m0(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Ll6/y3;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method private H()V
    ...
    iget-object v2, p0, Ll6/y3;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {v3, v1, v2}, Ll6/m3;-><init>([ZLandroid/database/sqlite/SQLiteStatement;)V

    invoke-virtual {v0, v3}, Ll6/z2$d;->e(Lq6/n;)I
...
.method private J()V
    ...
    sget-object v1, Ll6/o3;->a:Ll6/o3;
    ...
    new-instance v5, Ll6/z2$d;

    iget-object v6, p0, Ll6/y3;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {v5, v6, v7}, Ll6/z2$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v6}, Ll6/z2$d;->b([Ljava/lang/Object;)Ll6/z2$d;
    ...
    new-instance v6, Ll6/n3;

    invoke-direct {v6, v1, v0, v3, v4}, Ll6/n3;-><init>([ZLandroid/database/sqlite/SQLiteStatement;J)V

    invoke-virtual {v5, v6}, Ll6/z2$d;->e(Lq6/n;)I
...
.method private M()Z
    ...
    invoke-direct {p0, v0, v1}, Ll6/y3;->l0(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v1

    const-string v2, "read_time_nanos"

    invoke-direct {p0, v0, v2}, Ll6/y3;->l0(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private N([Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, v4}, Ll6/y3;->m0(Ljava/lang/String;)Z
    ...
    invoke-static {v0, p1, p2}, Lq6/v;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static synthetic V(Ll6/t0$a;Landroid/database/sqlite/SQLiteStatement;Lm6/u;)V
    .locals 1

    invoke-virtual {p0, p2}, Ll6/t0$a;->a(Lm6/u;)Z
    ...
    invoke-virtual {p2}, Lm6/e;->s()Lm6/e;
    ...
    invoke-static {p2}, Ll6/f;->c(Lm6/e;)Ljava/lang/String;
...
.method private static synthetic W(Lq6/n;Landroid/database/Cursor;)V
    .locals 1
...
.method private static synthetic X(Lq6/n;Landroid/database/Cursor;)V
    .locals 1
...
.method private synthetic Z(Landroid/database/Cursor;)V
    ...
    check-cast p1, Lo6/c$b;

    invoke-virtual {p1}, Lo6/c$b;->H()Lo6/c$b;
    ...
    iget-object v3, p0, Ll6/y3;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method public static synthetic a(Ll6/y3;)V
    .locals 0

    invoke-direct {p0}, Ll6/y3;->T()V
...
.method private static synthetic a0([ZLandroid/database/sqlite/SQLiteStatement;Landroid/database/Cursor;)V
    ...
    invoke-static {p0}, Ll6/f;->b(Ljava/lang/String;)Lm6/u;
    ...
    invoke-static {v1, p1, p0}, Lq6/b;->d(ZLjava/lang/String;[Ljava/lang/Object;)V

    return-void
.end method

.method public static synthetic b(Ll6/y3;)V
    .locals 0

    invoke-direct {p0}, Ll6/y3;->U()V
...
.method public static synthetic c(Ll6/y3;)V
    .locals 0

    invoke-direct {p0}, Ll6/y3;->R()V
...
.method public static synthetic d(Landroid/database/Cursor;)Ljava/lang/Long;
    ...
    invoke-static {p0}, Ll6/y3;->b0(Landroid/database/Cursor;)Ljava/lang/Long;
...
.method private synthetic d0(Ljava/lang/String;Landroid/database/Cursor;)V
    ...
    invoke-direct {p0, p1, p2}, Ll6/y3;->h0(Ljava/lang/String;I)V
...
.method public static synthetic e([ZLandroid/database/sqlite/SQLiteStatement;Landroid/database/Cursor;)V
    ...
    invoke-static {p0, p1, p2}, Ll6/y3;->a0([ZLandroid/database/sqlite/SQLiteStatement;Landroid/database/Cursor;)V
...
.method private synthetic e0(Landroid/database/Cursor;)V
    ...
    new-instance p1, Ll6/z2$d;

    iget-object v5, p0, Ll6/y3;->a:Landroid/database/sqlite/SQLiteDatabase;

    const-string v6, "SELECT batch_id FROM mutations WHERE uid = ? AND batch_id <= ?"

    invoke-direct {p1, v5, v6}, Ll6/z2$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v5}, Ll6/z2$d;->b([Ljava/lang/Object;)Ll6/z2$d;

    move-result-object p1

    new-instance v0, Ll6/j3;

    invoke-direct {v0, p0, v1}, Ll6/j3;-><init>(Ll6/y3;Ljava/lang/String;)V
...
.method public static synthetic f(Ll6/t0$a;Landroid/database/sqlite/SQLiteStatement;Lm6/u;)V
    .locals 0

    invoke-static {p0, p1, p2}, Ll6/y3;->V(Ll6/t0$a;Landroid/database/sqlite/SQLiteStatement;Lm6/u;)V
...
.method private synthetic f0(Landroid/database/Cursor;)V
    ...
    iget-object v3, p0, Ll6/y3;->b:Ll6/o;

    invoke-virtual {v3, p1}, Ll6/o;->h(Lo6/c;)Ll6/h4;
...
.method public static synthetic g(Ll6/y3;)V
    .locals 0

    invoke-direct {p0}, Ll6/y3;->Y()V
...
.method private g0()V
    ...
    new-instance v1, Ll6/i3;

    invoke-direct {v1, p0}, Ll6/i3;-><init>(Ll6/y3;)V
...
.method public static synthetic h(Lq6/n;Landroid/database/Cursor;)V
    .locals 0

    invoke-static {p0, p1}, Ll6/y3;->W(Lq6/n;Landroid/database/Cursor;)V
...
.method public static synthetic i(Ll6/y3;)V
    .locals 0

    invoke-direct {p0}, Ll6/y3;->P()V
...
.method private i0()V
    ...
    invoke-direct {v1, p0}, Ll6/h3;-><init>(Ll6/y3;)V
...
.method public static synthetic j(Ll6/y3;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1}, Ll6/y3;->Z(Landroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic k(Ll6/y3;)V
    .locals 0

    invoke-direct {p0}, Ll6/y3;->O()V

    return-void
.end method

.method public static synthetic l(Ll6/y3;)V
    .locals 0

    invoke-direct {p0}, Ll6/y3;->Q()V
...
.method private l0(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Ll6/y3;->L(Ljava/lang/String;)Ljava/util/List;
...
.method public static synthetic m(Ll6/y3;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1}, Ll6/y3;->f0(Landroid/database/Cursor;)V
...
.method public static synthetic n(Ll6/y3;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1}, Ll6/y3;->e0(Landroid/database/Cursor;)V
...
.method public static synthetic o([ZLandroid/database/sqlite/SQLiteStatement;JLandroid/database/Cursor;)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, Ll6/y3;->c0([ZLandroid/database/sqlite/SQLiteStatement;JLandroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic p(Ll6/y3;Ljava/lang/String;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Ll6/y3;->d0(Ljava/lang/String;Landroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic q(Lq6/n;Landroid/database/Cursor;)V
    .locals 0

    invoke-static {p0, p1}, Ll6/y3;->X(Lq6/n;Landroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic r(Ll6/y3;)V
    .locals 0

    invoke-direct {p0}, Ll6/y3;->S()V
...
.method private x()V
    ...
    new-instance v1, Ll6/t3;

    invoke-direct {v1, p0}, Ll6/t3;-><init>(Ll6/y3;)V
...
.method private y()V
    ...
    invoke-direct {v1, p0}, Ll6/s3;-><init>(Ll6/y3;)V
...
.method private z()V
    ...
    invoke-direct {v1, p0}, Ll6/u3;-><init>(Ll6/y3;)V
...
.method j0(I)V
    ...
    invoke-virtual {p0, p1, v0}, Ll6/y3;->k0(II)V
...
.method k0(II)V
    ...
    invoke-direct {p0}, Ll6/y3;->B()V

    invoke-direct {p0}, Ll6/y3;->D()V

    invoke-direct {p0}, Ll6/y3;->C()V
    ...
    invoke-direct {p0}, Ll6/y3;->K()V

    invoke-direct {p0}, Ll6/y3;->w()V
    ...
    invoke-direct {p0}, Ll6/y3;->A()V

    invoke-direct {p0}, Ll6/y3;->y()V

    sget-object v4, Ll6/e1;->b:Ljava/lang/String;

    invoke-direct {p0, v4}, Ll6/y3;->t(Ljava/lang/String;)V
    ...
    invoke-static {p1, p2, v3}, Lq6/v;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
