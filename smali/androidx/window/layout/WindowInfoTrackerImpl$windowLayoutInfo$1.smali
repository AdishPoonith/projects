...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/window/layout/WindowInfoTrackerImpl;->windowLayoutInfo(Landroid/app/Activity;)Loa/b;
.end annotation
...
# direct methods
.method constructor <init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lv9/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static synthetic a(Lna/f;Landroidx/window/layout/WindowLayoutInfo;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invokeSuspend$lambda-0(Lna/f;Landroidx/window/layout/WindowLayoutInfo;)V

    return-void
.end method

.method private static final invokeSuspend$lambda-0(Lna/f;Landroidx/window/layout/WindowLayoutInfo;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lna/t;->a(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final create(Ljava/lang/Object;Lv9/d;)Lv9/d;
    ...
    invoke-direct {v0, v1, v2, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;-><init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lv9/d;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invoke(Loa/c;Lv9/d;)Ljava/lang/Object;
...
.method public final invoke(Loa/c;Lv9/d;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->create(Ljava/lang/Object;Lv9/d;)Lv9/d;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v4, Lna/e;->k:Lna/e;

    const/4 v5, 0x4

    const/4 v6, 0x0

    invoke-static {v1, v4, v6, v5, v6}, Lna/h;->b(ILna/e;Lda/l;ILjava/lang/Object;)Lna/f;

    move-result-object v1

    new-instance v4, Landroidx/window/layout/c;

    invoke-direct {v4, v1}, Landroidx/window/layout/c;-><init>(Lna/f;)V
    ...
    sget-object v7, Landroidx/profileinstaller/g;->j:Landroidx/profileinstaller/g;
    ...
    :try_start_2
    invoke-interface {v1}, Lna/p;->iterator()Lna/g;
    ...
    invoke-interface {v1, v5}, Lna/g;->a(Lv9/d;)Ljava/lang/Object;
    ...
    invoke-interface {v1}, Lna/g;->next()Ljava/lang/Object;
    ...
    invoke-interface {v6, p1, v5}, Loa/c;->emit(Ljava/lang/Object;Lv9/d;)Ljava/lang/Object;
