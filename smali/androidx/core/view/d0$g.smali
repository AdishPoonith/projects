...
.field private f:Landroidx/core/view/d0;
...
.method constructor <init>(Landroidx/core/view/d0;Landroid/view/WindowInsets;)V
    ...
    iput-object p1, p0, Landroidx/core/view/d0$g;->e:Landroidx/core/graphics/b;
...
.method private s(IZ)Landroidx/core/graphics/b;
    ...
    :cond_0
    invoke-virtual {p0, v1, p2}, Landroidx/core/view/d0$g;->t(IZ)Landroidx/core/graphics/b;
...
.method private u()Landroidx/core/graphics/b;
    ...
    iget-object v0, p0, Landroidx/core/view/d0$g;->f:Landroidx/core/view/d0;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Landroidx/core/view/d0;->g()Landroidx/core/graphics/b;
...
.method private v(Landroid/view/View;)Landroidx/core/graphics/b;
    ...
    sget-boolean v1, Landroidx/core/view/d0$g;->h:Z

    if-nez v1, :cond_0

    invoke-static {}, Landroidx/core/view/d0$g;->w()V

    :cond_0
    sget-object v1, Landroidx/core/view/d0$g;->i:Ljava/lang/reflect/Method;

    const/4 v2, 0x0

    if-eqz v1, :cond_4

    sget-object v3, Landroidx/core/view/d0$g;->j:Ljava/lang/Class;

    if-eqz v3, :cond_4

    sget-object v3, Landroidx/core/view/d0$g;->k:Ljava/lang/reflect/Field;
...
.method private static w()V
    ...
    sput-object v1, Landroidx/core/view/d0$g;->i:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sput-boolean v0, Landroidx/core/view/d0$g;->h:Z
...
.method d(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, Landroidx/core/view/d0$g;->v(Landroid/view/View;)Landroidx/core/graphics/b;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/core/view/d0$g;->p(Landroidx/core/graphics/b;)V
...
.method e(Landroidx/core/view/d0;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/core/view/d0;->o(Landroidx/core/view/d0;)V

    iget-object v0, p0, Landroidx/core/view/d0$g;->g:Landroidx/core/graphics/b;

    invoke-virtual {p1, v0}, Landroidx/core/view/d0;->n(Landroidx/core/graphics/b;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Landroidx/core/view/d0$g;->g:Landroidx/core/graphics/b;
...
.method public g(I)Landroidx/core/graphics/b;
    ...
    invoke-direct {p0, p1, v0}, Landroidx/core/view/d0$g;->s(IZ)Landroidx/core/graphics/b;
...
.method final k()Landroidx/core/graphics/b;
    ...
    iget-object v0, p0, Landroidx/core/view/d0$g;->e:Landroidx/core/graphics/b;
    ...
    iput-object v0, p0, Landroidx/core/view/d0$g;->e:Landroidx/core/graphics/b;
...
.method public o([Landroidx/core/graphics/b;)V
    ...
    iput-object p1, p0, Landroidx/core/view/d0$g;->d:[Landroidx/core/graphics/b;
...
.method p(Landroidx/core/graphics/b;)V
    ...
    iput-object p1, p0, Landroidx/core/view/d0$g;->g:Landroidx/core/graphics/b;
...
.method q(Landroidx/core/view/d0;)V
    ...
    iput-object p1, p0, Landroidx/core/view/d0$g;->f:Landroidx/core/view/d0;
...
.method protected t(IZ)Landroidx/core/graphics/b;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/core/view/d0$g;->f:Landroidx/core/view/d0;

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Landroidx/core/view/d0;->e()Landroidx/core/view/c;
    ...
    :cond_3
    invoke-virtual {p0}, Landroidx/core/view/d0$l;->l()Landroidx/core/graphics/b;
    ...
    :cond_4
    invoke-virtual {p0}, Landroidx/core/view/d0$l;->h()Landroidx/core/graphics/b;
    ...
    :cond_5
    invoke-virtual {p0}, Landroidx/core/view/d0$l;->j()Landroidx/core/graphics/b;
    ...
    :cond_6
    iget-object p1, p0, Landroidx/core/view/d0$g;->d:[Landroidx/core/graphics/b;

    if-eqz p1, :cond_7

    invoke-static {p2}, Landroidx/core/view/d0$m;->a(I)I
    ...
    :cond_8
    invoke-virtual {p0}, Landroidx/core/view/d0$g;->k()Landroidx/core/graphics/b;

    move-result-object p1

    invoke-direct {p0}, Landroidx/core/view/d0$g;->u()Landroidx/core/graphics/b;
    ...
    :cond_9
    iget-object p1, p0, Landroidx/core/view/d0$g;->g:Landroidx/core/graphics/b;
    ...
    invoke-virtual {p0}, Landroidx/core/view/d0$l;->i()Landroidx/core/graphics/b;
    ...
    iget-object p2, p0, Landroidx/core/view/d0$g;->f:Landroidx/core/view/d0;

    if-eqz p2, :cond_d

    invoke-virtual {p2}, Landroidx/core/view/d0;->g()Landroidx/core/graphics/b;
