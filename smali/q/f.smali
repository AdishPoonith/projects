...
.method private b(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :cond_0
    invoke-direct {p0, v0}, Lq/f;->a(Landroid/os/Bundle;)V
...
.method public f(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    invoke-direct {p0, p2}, Lq/f;->b(Landroid/os/Bundle;)Landroid/os/Bundle;

    move-result-object p2

    :try_start_0
    iget-object v0, p0, Lq/f;->b:La/b;

    iget-object v1, p0, Lq/f;->c:La/a;

    invoke-interface {v0, v1, p1, p2, p3}, La/b;->I0(La/a;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
