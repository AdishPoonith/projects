...
.method public static synthetic zzb(Lcom/google/android/recaptcha/internal/zzw;Landroid/app/Application;Ljava/lang/String;Lcom/google/android/recaptcha/internal/zzr;Landroid/webkit/WebView;Lv9/d;ILjava/lang/Object;)Ljava/lang/Object;
    .locals 8
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/google/android/recaptcha/internal/zzw;->zza(Landroid/app/Application;Ljava/lang/String;Lcom/google/android/recaptcha/internal/zzr;Landroid/webkit/WebView;Lv9/d;)Ljava/lang/Object;
...
# virtual methods
.method public final zza(Landroid/app/Application;Ljava/lang/String;Lcom/google/android/recaptcha/internal/zzr;Landroid/webkit/WebView;Lv9/d;)Ljava/lang/Object;
    .locals 23
    ...
    invoke-direct {v1, v2, v0}, Lcom/google/android/recaptcha/internal/zzv;-><init>(Lcom/google/android/recaptcha/internal/zzw;Lv9/d;)V
    ...
    :try_start_0
    invoke-static {v0}, Ls9/o;->b(Ljava/lang/Object;)V
    :try_end_0
    ...
    invoke-virtual {v0}, Ls9/n;->i()Ljava/lang/Object;
    ...
    invoke-interface {v0, v8, v1}, Lkotlinx/coroutines/sync/b;->b(Ljava/lang/Object;Lv9/d;)Ljava/lang/Object;
    ...
    invoke-direct/range {v12 .. v17}, Lcom/google/android/recaptcha/internal/zzao;-><init>(Landroid/content/Context;Lcom/google/android/recaptcha/internal/zzap;Lla/k0;ILkotlin/jvm/internal/g;)V
    ...
    invoke-direct/range {v12 .. v20}, Lcom/google/android/recaptcha/internal/zzda;-><init>(Landroid/webkit/WebView;Ljava/lang/String;Landroid/content/Context;Lcom/google/android/recaptcha/internal/zzr;Ljava/lang/String;Ljava/lang/String;Lcom/google/android/recaptcha/internal/zzaj;Lla/k0;)V
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/recaptcha/internal/zzda;->zzg(Lv9/d;)Ljava/lang/Object;
    ...
    invoke-interface {v4}, Lla/k0;->n()Lv9/g;

    move-result-object v4

    invoke-static {v4, v8, v7, v8}, Lla/z1;->f(Lv9/g;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
    ...
    invoke-static {v4}, Lla/z1;->j(Lv9/g;)Lla/v1;

    move-result-object v4

    invoke-interface {v4}, Lla/v1;->w()Lja/b;

    move-result-object v4

    invoke-static {v4}, Lja/e;->g(Lja/b;)Ljava/util/List;
    ...
    invoke-static {v4, v1}, Lla/e;->a(Ljava/util/Collection;Lv9/d;)Ljava/lang/Object;
