...
.field private final b:Lo3/f$a$a;

.field private final c:Lo3/n0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lo3/s;->p:Lcom/google/common/collect/q;
    ...
    sput-object v3, Lo3/s;->q:Lcom/google/common/collect/q;
    ...
    sput-object v3, Lo3/s;->r:Lcom/google/common/collect/q;
    ...
    sput-object v3, Lo3/s;->s:Lcom/google/common/collect/q;
    ...
    sput-object v1, Lo3/s;->t:Lcom/google/common/collect/q;
    ...
    sput-object v0, Lo3/s;->u:Lcom/google/common/collect/q;

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Ljava/util/Map;ILp3/d;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lo3/s;->a:Lcom/google/common/collect/r;

    new-instance p2, Lo3/f$a$a;

    invoke-direct {p2}, Lo3/f$a$a;-><init>()V

    iput-object p2, p0, Lo3/s;->b:Lo3/f$a$a;

    new-instance p2, Lo3/n0;

    invoke-direct {p2, p3}, Lo3/n0;-><init>(I)V

    iput-object p2, p0, Lo3/s;->c:Lo3/n0;

    iput-object p4, p0, Lo3/s;->d:Lp3/d;

    iput-boolean p5, p0, Lo3/s;->e:Z
    ...
    invoke-virtual {p1}, Lp3/y;->f()I

    move-result p2

    iput p2, p0, Lo3/s;->i:I

    invoke-direct {p0, p2}, Lo3/s;->m(I)J

    move-result-wide p2

    iput-wide p2, p0, Lo3/s;->l:J

    new-instance p2, Lo3/r;

    invoke-direct {p2, p0}, Lo3/r;-><init>(Lo3/s;)V

    invoke-virtual {p1, p2}, Lp3/y;->i(Lp3/y$c;)V
    ...
    iput p1, p0, Lo3/s;->i:I

    invoke-direct {p0, p1}, Lo3/s;->m(I)J

    move-result-wide p1

    iput-wide p1, p0, Lo3/s;->l:J

    :goto_0
    return-void
.end method

.method synthetic constructor <init>(Landroid/content/Context;Ljava/util/Map;ILp3/d;ZLo3/s$a;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lo3/s;-><init>(Landroid/content/Context;Ljava/util/Map;ILp3/d;Z)V

    return-void
.end method

.method public static synthetic j(Lo3/s;I)V
    .locals 0

    invoke-direct {p0, p1}, Lo3/s;->q(I)V
...
.method static synthetic k(Ljava/lang/String;)[I
    ...
    invoke-static {p0}, Lo3/s;->l(Ljava/lang/String;)[I
...
.method private m(I)J
    ...
    iget-object v0, p0, Lo3/s;->a:Lcom/google/common/collect/r;
    ...
    iget-object p1, p0, Lo3/s;->a:Lcom/google/common/collect/r;
...
.method public static declared-synchronized n(Landroid/content/Context;)Lo3/s;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lo3/s;->v:Lo3/s;

    if-nez v1, :cond_0

    new-instance v1, Lo3/s$b;

    invoke-direct {v1, p0}, Lo3/s$b;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1}, Lo3/s$b;->a()Lo3/s;

    move-result-object p0

    sput-object p0, Lo3/s;->v:Lo3/s;

    :cond_0
    sget-object p0, Lo3/s;->v:Lo3/s;
    :try_end_0
...
.method private static o(Lo3/p;Z)Z
    .locals 0
    ...
    invoke-virtual {p0, p1}, Lo3/p;->d(I)Z
...
.method private p(IJJ)V
    ...
    :cond_0
    iput-wide p4, p0, Lo3/s;->m:J

    iget-object v3, p0, Lo3/s;->b:Lo3/f$a$a;
    ...
    invoke-virtual/range {v3 .. v8}, Lo3/f$a$a;->c(IJJ)V
...
.method private declared-synchronized q(I)V
    ...
    :try_start_0
    iget v0, p0, Lo3/s;->i:I

    if-eqz v0, :cond_0

    iget-boolean v1, p0, Lo3/s;->e:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iput-wide v0, p0, Lo3/s;->l:J

    iget-object p1, p0, Lo3/s;->d:Lp3/d;

    invoke-interface {p1}, Lp3/d;->a()J

    move-result-wide v0

    iget p1, p0, Lo3/s;->f:I

    if-lez p1, :cond_4

    iget-wide v2, p0, Lo3/s;->g:J
    ...
    :goto_0
    iget-wide v4, p0, Lo3/s;->h:J

    iget-wide v6, p0, Lo3/s;->l:J

    move-object v2, p0

    invoke-direct/range {v2 .. v7}, Lo3/s;->p(IJJ)V

    iput-wide v0, p0, Lo3/s;->g:J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lo3/s;->h:J

    iput-wide v0, p0, Lo3/s;->k:J

    iput-wide v0, p0, Lo3/s;->j:J

    iget-object p1, p0, Lo3/s;->c:Lo3/n0;

    invoke-virtual {p1}, Lo3/n0;->i()V
    :try_end_2
...
# virtual methods
.method public a()Lo3/p0;
    .locals 0

    return-object p0
.end method

.method public b(Lo3/l;Lo3/p;Z)V
    .locals 0

    return-void
.end method

.method public declared-synchronized c(Lo3/l;Lo3/p;Z)V
    .locals 10

    monitor-enter p0

    :try_start_0
    invoke-static {p2, p3}, Lo3/s;->o(Lo3/p;Z)Z
    ...
    iget-wide v2, p0, Lo3/s;->j:J

    int-to-long v6, v5

    add-long/2addr v2, v6

    iput-wide v2, p0, Lo3/s;->j:J

    iget-wide v2, p0, Lo3/s;->k:J

    iget-wide v6, p0, Lo3/s;->h:J

    add-long/2addr v2, v6

    iput-wide v2, p0, Lo3/s;->k:J
    ...
    iget-object p3, p0, Lo3/s;->c:Lo3/n0;
    ...
    invoke-virtual {p3, v2, p1}, Lo3/n0;->c(IF)V
    ...
    invoke-virtual {p1, p3}, Lo3/n0;->f(F)F

    move-result p1

    float-to-long v2, p1

    iput-wide v2, p0, Lo3/s;->l:J

    :cond_3
    iget-wide v6, p0, Lo3/s;->h:J

    iget-wide v8, p0, Lo3/s;->l:J

    move-object v4, p0

    invoke-direct/range {v4 .. v9}, Lo3/s;->p(IJJ)V
...
.method public d(Lo3/f$a;)V
    .locals 1

    iget-object v0, p0, Lo3/s;->b:Lo3/f$a$a;

    invoke-virtual {v0, p1}, Lo3/f$a$a;->e(Lo3/f$a;)V

    return-void
.end method

.method public declared-synchronized e(Lo3/l;Lo3/p;ZI)V
    .locals 0
...
.method public synthetic f()J
    ...
    invoke-static {p0}, Lo3/d;->a(Lo3/f;)J
...
.method public declared-synchronized h(Lo3/l;Lo3/p;Z)V
    .locals 0
...
.method public i(Landroid/os/Handler;Lo3/f$a;)V
    .locals 1
    ...
    invoke-virtual {v0, p1, p2}, Lo3/f$a$a;->b(Landroid/os/Handler;Lo3/f$a;)V
