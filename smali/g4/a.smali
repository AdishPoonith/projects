...
.field private static volatile c:Lg4/a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lg4/a;->b:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lg4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static a()Lg4/a;
    ...
    sget-object v0, Lg4/a;->c:Lg4/a;

    if-nez v0, :cond_1

    sget-object v0, Lg4/a;->b:Ljava/lang/Object;
...
.method private final e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    ...
    :try_start_0
    invoke-static {p1}, Lj4/c;->a(Landroid/content/Context;)Lj4/b;

    move-result-object v2

    invoke-virtual {v2, p6, v1}, Lj4/b;->a(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Lg4/a;->f(Landroid/content/ServiceConnection;)Z

    move-result p6

    if-eqz p6, :cond_4

    iget-object p6, p0, Lg4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p7}, Lg4/a;->g(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    :cond_3
    iget-object p1, p0, Lg4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p2, p0, Lg4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public b(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    invoke-static {p2}, Lg4/a;->f(Landroid/content/ServiceConnection;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lg4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v0}, Lg4/a;->d(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    invoke-static {p1, p2}, Lg4/a;->d(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final c(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    invoke-direct/range {v0 .. v7}, Lg4/a;->e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
